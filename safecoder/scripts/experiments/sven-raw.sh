...
do
    OUTPUT_NAME=${PRETRAIN_NAME}-sven-raw-kl${KL}
    python train.py --pretrain_name ${PRETRAIN_NAME} --output_name ${OUTPUT_NAME} --sven --datasets sec-desc --sampling_size -1 --kl_loss_weight ${KL}
