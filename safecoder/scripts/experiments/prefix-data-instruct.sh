...
do
    OUTPUT_NAME=${PRETRAIN_NAME}-prefix-data-instruct-kl${KL}
    python train.py --pretrain_name ${PRETRAIN_NAME} --output_name ${OUTPUT_NAME} --datasets sec-desc sec-new-desc 476-desc --sampling_size ${SAMPLE_SIZE} --kl_loss_weight ${KL}
