...
def main():
    with open(os.path.join(args.raw, 'data_autofix_tracking_eslint_final.json'), 'r', errors='ignore') as f:
        all_samples = json.load(f)
    with open(os.path.join(args.raw, 'data_autofix_tracking_repo_specific_final.json'), 'r', errors='ignore') as f:
        all_samples += json.load(f)
